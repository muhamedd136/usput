...
const OrderCard = (props) => {
	...
	const [acceptRequestedModalShow, setAcceptRequestedModalShow] = useState(false);
	...
	const generateModal = (showModal, handleShowModal, title, text, onSubmit, confirmationButtonText) => {
		return (
			...
			<div className="OrderCard-thirdRow">
				{selected !== 1 ? (
					<>
						...
						{selected !== 2 ? (
							<Button size="sm" variant="outline-danger" onClick={handleCancelAppliedModalShow}>
								Cancel
							</Button>
						) : (
							<p>
					...
					<>
						...
						<div className="OrderCard-requestButtons">
							...
							<Button size="sm" variant="outline-info" onClick={handleAcceptRequestedModalShow}>
								Accept
							</Button>
						</div>
					</>
